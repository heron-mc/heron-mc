...
allowedHosts = ['local.lib.heron-mc.org','apps.heron-mc.org', 'geodata.nationaalgeoregister.nl', 'local.geodata.nationaalgeoregister.nl',
                'ontwikkel.geodata.nationaalgeoregister.nl', 'test.geodata.nationaalgeoregister.nl', 'integratie.geodata.nationaalgeoregister.nl',
                'acceptatie.geodata.nationaalgeoregister.nl', 'eto.geodata.nationaalgeoregister.nl', 'http:/www.dinoservices.nl']
