...
content:a,save:OpenLayers.Function.bind(this.downloadFeature,this),cancel:OpenLayers.Function.bind(this.cancelDialog,this),noHideOnSave:!0})}},downloadFeature:function(){var a=document.getElementById("format_select"),a=a.options[a.selectedIndex],b=this.formatters[a.value];if(!b)return null;this.fileProjection&&(b.internalProjection=this.layer.map.baseLayer.projection,b.externalProjection=b.fileProjection?b.fileProjection:this.fileProjection);var b=b.write(this.layer.features),c=document.getElementById("download_form"),
d=this.params.filename;this.params.filename=d+a.fileExt;this.params.mime=a.mimeType;this.params.data=b;this.params.source_format=a.sourceFormat;a.targetFormat&&(this.params.target_format=a.targetFormat);a.assignSrs&&(this.params.assign_srs=a.assignSrs);a.sourceSrs&&(this.params.source_srs=a.sourceSrs);a.targetSrs&&(this.params.target_srs=a.targetSrs);for(var e in this.params)c=this.createInputElm(e,"hidden",this.params[e],c);this.params.filename=d;c.submit();var f=this;setTimeout(function(){f.deactivate()},
2E3)},showMessage:function(a){this.map.editor.dialog.show({title:OpenLayers.i18n("oleDownloadFeature"),content:a})},createInputElm:function(a,b,c,d){var e=document.createElement("input");e.setAttribute("type",b);e.name=a;e.value=c?c:null;d&&d.appendChild(e);return d},CLASS_NAME:"OpenLayers.Editor.Control.DownloadFeature"});/*
  2011 geOps
 @author     Just van den Broecke
 @license    https://github.com/geops/ole/blob/master/license.txt
 @link       https://github.com/geops/ole
...
"file","file",null,b),c=document.createElement("select");c.setAttribute("name","format_select");c.setAttribute("id","format_select");for(var d,e=0;e<this.formats.length;++e){d=document.createElement("option");var f=this.formats[e],g=f.formatter;"string"==typeof g&&(g=eval("new "+g+"()"));g.fileProjection=f.fileProjection;this.formatters[f.name]=g;d.setAttribute("value",f.name);d.innerHTML=f.name;d.fileExt=f.fileExt;d.mimeType=f.mimeType;c.appendChild(d)}b.appendChild(c);var c=document.createElement("p"),
h=document.createElement("input");h.type="checkbox";h.id="oleUploadFeatureReplace";h.name="uploadFeatureReplace";h.value="true";h.checked=!0;h.defaultChecked=!0;this.setReplaceFeatures(h.checked);c.appendChild(h);OpenLayers.Event.observe(c,"click",OpenLayers.Function.bind(function(a){OpenLayers.Event.stop(a,!0);this.setReplaceFeatures(h.checked)},this));d=document.createElement("label");d.htmlFor="oleUploadFeatureReplace";d.appendChild(document.createTextNode(OpenLayers.i18n("oleUploadFeatureReplace")));
