...
c.appendChild(d);b.appendChild(c);c=document.createElement("div");var e=document.createElement("select");e.id="oleCADToolsDialogSides";for(var f=0;f<this.sides.length;++f)d=document.createElement("option"),d.value=this.sides[f],d.text=20>this.sides[f]?OpenLayers.i18n("oleDrawRegularSides"+this.sides[f]):OpenLayers.i18n("oleDrawRegularCircle"),e.appendChild(d);OpenLayers.Event.observe(e,"change",OpenLayers.Function.bind(function(a){this.handler.setOptions({sides:parseInt(a.target.value)})},this));
this.handler.setOptions({sides:parseInt(e.value)});c.appendChild(e);d=document.createElement("label");d.htmlFor="oleCADToolsDialogSides";d.appendChild(document.createTextNode(OpenLayers.i18n("oleDrawRegularShape")));c.appendChild(d);b.appendChild(c);this.map.editor.dialog.show({content:b,toolbox:!0});return a},deactivate:function(){var a=OpenLayers.Control.Button.prototype.deactivate.call(this);a&&this.map.editor.dialog.hide();return a},drawFeature:function(a){var b=new OpenLayers.Feature.Vector(a);
...
oleSnappingSettingsTolerance:"Tolerancia de l'ajust automàtic",oleSplitFeature:"Partir la geometria seleccionada"});OpenLayers.Lang.de=OpenLayers.Util.extend(OpenLayers.Lang.de,{oleCleanFeature:"Selektierte Geometrien bereinigen",oleDeleteFeature:"Selektierte Geometrien löschen",oleDragFeature:"Geometrie verschieben",oleDrawHole:"Loch schneiden",oleDrawPolygon:"Fläche erstellen",oleDrawPath:"Linie erstellen",oleDrawPoint:"Punkt erstellen",oleDrawRegular:"Gleichseitige Form erstellen",oleDrawRegularShape:"Form",oleDrawRegularIrregular:"nicht gleichseitig",oleDrawRegularSides3:"Dreieck",oleDrawRegularSides4:"Viereck",
oleDrawRegularSides5:"Fünfeck",oleDrawRegularSides6:"Sechseck",oleDrawRegularCircle:"Kreis",oleImportFeature:"Selektierte Geometrien importieren",oleImportFeatureSourceLayer:"Keine Ebenen für den Import gefunden",oleImportFeatureSourceFeature:"Keine selektierten Geometrien für den Import gefunden.",oleLayerSettingsImportHeader:"Import",oleLayerSettingsImportLabel:"Layer als Quelle für Import verwenden",oleLayerSettingsLegendHeader:"Legende",oleLayerSettingsOpacityHeader:"Opazität in %",oleMergeFeature:"Selektierte Geometrien verschmelzen",
oleMergeFeatureSelectFeature:"Bitte mindestens 2 Flächen auswählen.",oleModifyFeature:"Geometrien bearbeiten",oleNavigation:"Navigation",olePixelUnit:"px",oleSelectFeature:"Geometrien selektieren",oleSnappingSettings:"Snapping Einstellungen",oleSnappingSettingsLayer:"Snapping Layer",oleSnappingSettingsTolerance:"Snapping Toleranz in px",oleSplitFeature:"Selektierte Geometrien teilen",oleTransformFeature:"Geometrie skalieren, drehen und verschieben",oleCADTools:"CAD Funktionen",oleCADToolsDialogParallelDrawing:"Paralleles Zeichnen aktivieren",
...
oleDrawRegularSides5:"vijfhoek",oleDrawRegularSides6:"zeshoek",oleDrawRegularCircle:"cirkel",oleImportFeature:"Importeer geselecteerde geometrie",oleImportFeatureSourceLayer:"Geen bron-laag.",oleImportFeatureSourceFeature:"Selecteer eerst een geometrie.",oleLayerSettingsImportHeader:"Importeer",oleLayerSettingsImportLabel:"Gebruik als bron-laag",olelayerSettingsLegendHeader:"Legenda",olelayerSettingsOpacityHeader:"Ondoorzichtigheid (%)",oleMergeFeature:"Combineer geselecteerde geometrie",oleMergeFeatureSelectFeature:"Selecteer tenminste 2 geometrieën.",
oleModifyFeature:"Geometrie wijzigen",oleNavigation:"Navigatie",olePixelUnit:"px",oleSelectFeature:"Selecteer geometrie",oleSnappingSettings:"Uitlijn-instellingen",oleSnappingSettingsLayer:"Uitlijnen laag",oleSnappingSettingsTolerance:"Uitlijn-tolerantie",oleSplitFeature:"Splits geselecteerde geometrie",oleTransformFeature:"Geometrie schalen, roteren en verschuiven",oleCADTools:"CAD Functies",oleCADToolsDialogParallelDrawing:"Parallel tekenen aktiveren",oleCADToolsDialogGuidedDrawing:"Geleid tekenen aktiveren",
oleCADToolsDialogShowLayer:"Toon hulplijnen",oleCADToolsDialogTolerance:"px tolerantie",oleDialogCancelButton:"Annuleren",oleDialogSaveButton:"Bewaren",oleDialogOkButton:"Oke"});
