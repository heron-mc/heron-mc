...
Heron.i18n.dict = {
    ...
    'Change Layer opacity': 'Změnit opacitu vrstvy',
    ...
    'Details': 'Detaily',
    'Table': 'Tabulka',
    'Show record(s) in a table grid': 'Ukázat záznam(y) v tabulce',
    'Show single record': 'Ukázat jednotlivý záznam',
    'Show next record': 'Ukázat další záznam',
    'Show previous record': 'Ukázat předchozí záznam',
    'Feature tooltips' : 'Tooltipy prvků',
    'FeatureTooltip' : 'FeatureTooltip',
    'Upload features from local file' : 'Nahrát prvky z lokálního souboru',
    'My Upload' : 'Moje nahrané',
    'Anything is allowed here' : 'Zde je vše dovoleno',
    'Edit vector Layer styles' : 'Upravit styly vektorové vrstvy',
    'Style Editor' : 'Editor stylů',
    'Open a map context (layers, styling, extent) from file' : 'Otevřít kontext mapy (vrstvy, styly, rozsah) ze souboru',
    'Save current map context (layers, styling, extent) to file' : 'Uložit aktuální kontext mapy (layers, styling, extent) do souboru',
    'Upload' : 'Nahrát',
    'Uploading file...' : 'Nahrávání souboru...',
    'Change feature styles': 'Změnit styly prvků',
    'Error reading map file, map has not been loaded.': 'Chyba při čtení souboru mapy, mapa nebyla nahrána.',
    'Error on removing layers.': 'Chyba při odebírání vrstev.',
    'Error loading map file.': 'Chyba při nahrávání souboru mapy.',
    'Error reading layer tree.': 'Chyba při čtení stromu vrstev.',

    // 1.0.2
    'No file specified.': 'Žádný soubor nebyl specifikován.',
    'Cannot render draw controls': 'Nelze vykreslit kreslící nástroje',
    'Warning - Line Length is ': 'Varování - Délka linie je ',
    'You drew a line with length above the layer-maximum of ': 'Nakreslili jste linii delší, než je ve vrstvě povoleno ',
    'Warning - Area is ': 'Varování - Plocha je ',
    'You selected an area for this layer above its maximum of ': 'Vybrali jste plochu větší, než je ve vrstvě povoleno ',
    'Error creating Layer': 'Chyba při vytváření vrstvy',
    'Error in ajax request': 'Chyba při AJAX požadavku',
    'Add layers': 'Přidat vrstvy',
    'Remove layer': 'Odebrat vrstvu',
    'Loading map context from:': 'Nahrávání kontextu mapy z:',

    // 1.0.3 (nothing added)

    // 1.0.4
    'INTERSECTS (default)': 'PROTÍNÁ (implicitní)',
    'WITHIN': 'V RÁMCI',
    'WITHIN DISTANCE': 'VE VZDÁLENOSTI',
    'CONTAINS': 'OBSAHUJE',
    ...
    'Reset': 'Reset',
    // 'Details': 'Detaily',
    'Choose Layer to select with' : 'Zvolte vrstvu pro výběr',
    'Select a source Layer and then draw to select objects from that layer. <br/>Then select a target Layer to search in using the geometries of the selected objects.': 'Vyberte zdrojovou vrstvu a kreslete pro výběr objektů z této vrstvy.<br/>Pak vyberte cílovou vrstvu pro vyhledávání v pomocí geometrie vybraných objektů.',
    'Select a draw tool and draw to select objects from' : 'Vyberte kreslící nástroj a použijte jej pro výběr objektů z',
    'Select a target layer to search using the geometries of the selected objects': 'Vyberte cílovou vrstvu pro vyhledávání pomocí geometrií vybraných objektů',
    'objects selected from "': 'objekty vybrány z "',
    'Search in target layer using the feature-geometries from the selection' : 'Vyhledávání v cílové vrstvě za použití geometrií prvků z výběru',
    'Select the spatial operator (optional) and use the Search button to start your search.': 'Zvolte prostorový operátor (volitelně) a tlačítkem Hledat spusťte vyhledávání.',
    'Type of Search': 'Typ vyhledávání',
    'This field is required': 'Toto pole je povinné',
    'Select a drawing tool and draw to search immediately.': 'Vyberte kreslicí nástroj a nakreslete pro okamžité vyhledávání.',
    'Actions': 'Akce',
    'Cancel ongoing search': 'Zrušit probíhající vyhledávání',
    'Distance of Search': 'Vzdálenost vyhledávání',
    'Choose a Layer': 'Vyberte vrstvu',
    'No objects selected': 'Nevybrány žádné objekty',
    'Too many geometries for spatial filter': 'Příliš mnoho geometrií pro prostorový filtr',
    'Build your own searches': 'Sestavte si svá vlastní vyhledávání',
    // 'Get Layer information': 'Získat informace o vrstvě',
    // 'Edit Layer Style': 'Upravit styl vrstvy',
    'Style Editor (Vector)': 'Editor stylů (vektorů)',

    // 1.0.7
    'OverviewMap': 'Přepnout náhled mapy',
    'Click on map to view location in Google StreetView': 'Klikněte na mapu pro zobrazení polohy pomocí Google Street View'
