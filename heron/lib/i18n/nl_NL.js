...
Heron.i18n.dict = {
	...
	'Upload features from local file' : 'Laad features van lokaal bestand',
	'My Upload' : 'Mijn Upload',
	'Anything is allowed here' : 'Alles is toegestaan hier',
	'Edit vector Layer styles' : 'Edit vector Layer stijlen',
	'Style Editor' : 'Stijl Editor',
	'Open a map context (layers, styling, extent) from file' : 'Laad een kaartbeeld (lagen, stijlen etc) van lokaal bestand',
	'Save current map context (layers, styling, extent) to file' : 'Bewaar huidig kaartbeeld (lagen, stijlen etc) in lokaal bestand',
	'Upload' : 'Uploaden',
