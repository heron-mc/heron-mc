// See https://github.com/edspencer/Ext.ux.Exporter
 ...
 * Taken from: https://github.com/iwiznia/Ext.ux.Exporter
 * Needs to be backported to Ed Spencer's ExtJS3 version:
    ...
    getHeaders: function (store) {
        ...
        Ext.each(this.columns, function (col) {
            ...
            if (col.text != undefined) {
                ...
                // JvdB String.capitalize not in Ext3
